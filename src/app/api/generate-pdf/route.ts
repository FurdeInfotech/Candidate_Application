...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Launch Playwright with timeout and error handling
    ...
    // Set a higher timeout for Playwright (60 seconds)
...
<div style="border: 2px solid #000; padding: 20px 20px; min-height: 1035px;">
  ...
  <p style="margin-top: 0px">9. Experience: <span>${data.experience}</span></p>
